...
<section>
<p>Now you need to build your dynamic HTML string to add to the webpage. Declare a new <code>HTMLString</code> variable, and assign it an empty template literal string.</p>
</section>
</details>

<h4>preview</h4>
    <img src="https://github.com/AndriiKot/JS__Validation_by_Building_a_Calorie_Counter__freeCodeCamp/blob/main/images/previews/preview_step46.png" alt="preview_step46">
